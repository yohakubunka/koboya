...
<?php
//TEL
function the_tel_number($location) {
  $location_tel_number = array(
    'tel_link' => "0529286586",
  );
  echo $location_tel_number[$location];
}
?>
<?php
//オンラインショップ
function online_url($location) {
  $location_online_url = array(
    'online_link' => "https://koboya.myshopify.com/",
  );
  echo $location_online_url[$location];
}
?>
