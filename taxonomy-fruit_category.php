...
<div class="modal">
  ...
  <div class="modal__inner">
    ...
    <ul>
      <li>
        <a href="https://www.facebook.com/sharer/sharer.php?u=<?php the_permalink(); ?>" target="_blank" rel="nofollow noopener noreferrer">
      ...
      <li>
        ...
        url=<?php the_permalink(); ?>&text=<?php the_title(); ?>" target="_blank" rel="nofollow noopener noreferrer">
